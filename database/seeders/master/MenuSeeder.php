...
class MenuSeeder extends Seeder
{
    ...
    {
        $menus = json_decode(file_get_contents(database_path('seeders/data/list_menu.json')), true)[2]['data'];

        foreach ($menus as $menu) {
            DB::table('list_menu')->updateOrInsert(
                ['id_listmenu' => $menu['id_listmenu']],
                [
                    'name' => $menu['name'],
                    'icon' => $menu['icon'],
                    'path' => $menu['path'],
                    ...
                    'created_by' => $menu['created_by'] ?? null,
                    'updated_by' => $menu['updated_by'] ?? null,
                    'deleted_at' => $menu['deleted_at'] ?? null
                ]
            );
        }
    }
