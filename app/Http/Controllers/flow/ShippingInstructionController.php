...
class ShippingInstructionController extends Controller
{
    public function getShippingInstructions(Request $request)
    {
        ...
        $query = DB::table('shippinginstruction AS a')
            ->select('a.id_shippinginstruction', 'c.name_customer as agent','c.id_customer as id_agent', 'd.name_customer as consignee','d.id_customer as id_consignee', 'a.date', 'a.eta', 'a.etd', 'e.name_airport as pol', 'e.id_airport as id_pol', 'f.name_airport as pod', 'f.id_airport as id_pod', 'a.commodity', 'a.weight', 'a.pieces','a.dimensions', 'a.special_instructions', 'b.name as created_by', 'a.status')
